...
class Decode(object):
    ...
    # 处理一批图片
    def detect_batch(self, batch_img, fetch_list, draw_image):
    ...
    def predict(self, image, fetch_list, shape):
        outs = self.exe.run(self.program, feed={"input_1": image, }, fetch_list=fetch_list)
